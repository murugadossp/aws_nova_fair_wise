...
|-------|-----------|---------------------|
| Phase 1 | `create_session` | First `"Phase 1: N flights extracted"` line (inclusive) |
...
1. `nova_act.types.workflow __enter__` lines BEFORE `"Phase 1: N flights extracted"` = Phase 1 workflow starts. All others = Phase 3.
2. Attribute every WARNING/ERROR to its phase by timestamp.
